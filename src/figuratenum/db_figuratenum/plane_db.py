...
plane_highly_polygonal = [
    ...
    PlaneSchema(
        ...
        # A048906
        generating_function=x*(-133*x**2-64722*x-1) /
        (x**3-232323*x**2+232323*x-1),
        galois_group='',
        galois_description=""
    ),
    PlaneSchema(
        ...
        # A048909
        generating_function=x*(1+70*x+x**2)/((1-x)*(1-254*x+x**2)),
        galois_group='',
        galois_description=""
    ),
    PlaneSchema(
        ...
        # A036411
        generating_function=(
            (1 + 8*x + 182*x**2 + 8*x**3 + x**4)/((1-x)*(1 - 898*x**2 + x**4))),
        galois_group='',
        galois_description=""
    ),
    PlaneSchema(
    ...
    PlaneSchema(
        'nonagonal_octagonal',
        # A048924
        generating_function=x*(1 + 176850*x + 261*x ** 2) /
        ((1-x)*(1 - 454274*x + x ** 2)),
        galois_group='',
        galois_description=""
    ),
