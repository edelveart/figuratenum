...
from src.figuratenum.specific_space_figuratenum import (
    ...
    centered_pentagonal_pyramid_numbers, centered_hexagonal_pyramid_numbers, centered_heptagonal_pyramid_numbers, centered_octagonal_pyramid_numbers,

    centered_triangular_pyramidal_numbers, centered_square_pyramidal_numbers, centered_pentagonal_pyramidal_numbers, centered_heptagonal_pyramidal_numbers, centered_octagonal_pyramidal_numbers, centered_nonagonal_pyramidal_numbers, centered_decagonal_pyramidal_numbers, centered_hendecagonal_pyramidal_numbers, centered_dodecagonal_pyramidal_numbers
)
